...
<img src=img/32/traf.png border=0 title="Select VLAN for VLAN community indexing devices only">
</a></th>
<th>
Switch
...
<a href=Devices-Status.php?dev=<?=$ud?> ><img src=img/dev/<?=$img?>.png title="<?=$dev[3]?>" border=0></a>
