...
cat <<EOF
    ...
    Install NeDi on Ubuntu 6.06 LTS 

    This script will install Nedi on a stock Ubuntu 6.06 LTS installation.

     ---------- WARNING ----------
    You should only run this script ONCE.
    You should only run this script on a newly installed Ubuntu 6.06 LTS
    Your original configuration files will be saved with a .orig extension added
    UNSUPPORTED -  Please use at your own risk.   
   ---------- WARNING ---------

     Created by Tristan Rhodes
...
bannerme 'About to download NeDi'
{
